...
define('src/widget-extensions',[], function() {
	return {};
});

define('src/router/url',[
	"klassified"
], function(klassified) {
...
define('src/router/abstractSegment',[
	"klassified"
], function(klassified) {
	/**
...
define('src/router/parameterSegment',[
	"./abstractSegment"
...
define('src/router/optionalParameterSegment',[
	"./parameterSegment"
...
define('src/router/staticSegment',[
	"./abstractSegment"
], function(abstractSegment) {
...
define('src/router/routeFactory',[
	"./abstractSegment",
	"./parameterSegment",
...
define('src/router/routeMatchResult',[
	"klassified"
], function(klassified) {
...
define('src/router/hashLocation',[
	"jquery",
	"src/events",
	"./url",
	"klassified"
