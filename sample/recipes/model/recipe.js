define([
	 ...
	 */
	var recipeIngredient = objectjs.object.subclass(function(that, my) {
	 ...
	 */
	var recipeInstruction = objectjs.object.subclass(function(that, my) {
	 ...
	 */
	var recipe = objectjs.object.subclass(function(that, my) {
